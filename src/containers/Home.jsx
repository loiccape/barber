        ...
        <div className="md:h-[90vh]  flex flex-col p-4  text-white bg-zinc-800">
            ...
            <div className=' flex flex-col md:grid md:grid-cols-3 md:h-2/5  lg:w-3/4 mx-auto  '>
                ...
                <div className='  p-4 flex flex-col justify-evenly '>
                    <p className='text-4xl text-center md:text-start '>Votre coiffeur de confiance depuis 1995 !</p>
                    <Link to='/contact'>
                ...
                <div className='col-span-2 p-4 grid '>
                    <div className="h-full flex flex-col md:justify-center ">
                        <p className="text-6xl my-4 font-custom text-center">Saint Louis</p>
                        <p className="text-4xl font-custom text-center">Coiffure</p>
            ...
            <div className="md:grid md:grid-cols-3 md:grid-rows-2 md:gap-2 md:h-1/2 lg:h-3/5 w-full lg:w-3/4 mx-auto mt-6 md:mt-0">
                <div className=' text-center h-52 md:h-full rounded-xl bg-cover bg-center' style={{ backgroundImage: "url('https://uploads.lebonbon.fr/source/2022/november/18213/barbier-lyon_1_2000.jpg')" }}>
                </div>
